...
public class Capture extends InteractLawCard {
	...
	public void activateEffectCard() {
		...
		MainIsland.getInfo().setText("Select minion to capture. (ESC to cancle)");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						PlayerPanelUpdate.setShowMessage("I can't capture my minion.", COLOR_ERROR, 100, 2000);
					} catch(Exception e ) {
						PlayerPanelUpdate.setShowMessage("Fail.....", COLOR_ERROR, 100, 2000);
					}
					PlayerPanelUpdate.setPanelVisible(true);
