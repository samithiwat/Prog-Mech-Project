...
public class LawDeck {
	...
	public void setUpLawDeck() {
		Collections.addAll(lawDeck, new BanArWut(), new ChuayLeauKonJon(), new JubKaoKuk(), new KaYayPeunTeeSongKram()
				, new LongTodeKonShua(), new PaLangKonDee(), new PaLangYernTra(), new PaSeeArWut(), new PaSeeKarnKreunTee()
