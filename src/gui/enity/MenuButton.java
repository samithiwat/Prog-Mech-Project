...
public class MenuButton extends Button implements Clickable {
	...
	private final String FONT_PATH_REGULAR = "font/BaiJamjuree-Regular.ttf";
	private final String FONT_PATH_BOLD = "font/BaiJamjuree-Bold.ttf";
	...
	public MenuButton(String content,int contentSize,int width,int height) {
		getStyleClass().add("mainmenu-button");
		setText(content);
